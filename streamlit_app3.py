        ...
        if user_login_id == login_pwd_dict[login_pwd]:
            ...
            if access_array is not None:
                ...
                if login_access_dict[user_login_id] == "snr301":
                    ...
                    # file upload process for junior staff
                    # start of function definition for file upload
                    ...
                    # use the sourcedir_array for the selection
                    directory = st.selectbox("Select a directory", sourcedir_array)
                    # store file in our directory tree
